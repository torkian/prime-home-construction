      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <Image
              src="/logo/PHC_Logo_Footnote.png"
            ...
            <p className="mt-4 text-gray-300">
              ...
              unmatched quality. Licensed, insured, and trusted for over a decade.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition-colors hover:bg-primary-peach"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-gray-300 transition-colors hover:text-primary-peach"
                >
                  Home
                </Link>
              </li>
